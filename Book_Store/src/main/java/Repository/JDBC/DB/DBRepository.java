...
import Repository.JDBC.SortingRepository;
...
public class DBRepository<ID extends Serializable,T extends BaseEntity<ID>> implements SortingRepository<ID,T> {
    ...
    private static final String PASSWORD = "9d9d" ;// System.getProperty("password");
